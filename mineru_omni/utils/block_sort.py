...
from mineru_omni.utils.config_reader import get_device
from mineru_omni.utils.enum_class import BlockType, ModelPath
from mineru_omni.utils.models_download_utils import auto_download_and_get_model_root_path
...
def do_predict(boxes: List[List[int]], model) -> List[int]:
    from mineru_omni.model.reading_order.layout_reader import (
...
def cal_block_index(fix_blocks, sorted_bboxes):
    ...
    if sorted_bboxes is not None:
        ...
        import numpy as np
        from mineru_omni.model.reading_order.xycut import recursive_xy_cut
