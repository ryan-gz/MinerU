...
from mineru_omni.cli.common import prepare_env, read_fn, aio_do_parse, pdf_suffixes, image_suffixes
from mineru_omni.utils.cli_parser import arg_parse
from mineru_omni.utils.hash_utils import str_sha256
...
def main(ctx,
    ...
    if sglang_engine_enable:
        try:
            ...
            from mineru_omni.backend.vlm.vlm_analyze import ModelSingleton
